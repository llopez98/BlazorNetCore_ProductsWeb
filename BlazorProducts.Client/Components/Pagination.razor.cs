...
namespace BlazorProducts.Client.Components
{
    public partial class Pagination
    {
        ...
        //es llamado luego de que los parametros sean seteados
        protected override void OnParametersSet()
        {
            CreatePaginationLikns();
        }

        //este método crea los botones de previous, next, y las páginas
        private void CreatePaginationLikns() {
